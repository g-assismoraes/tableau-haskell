...
makeTree a
  | (head(head (formula a)) == '~') &&
    (head(tail(head (formula a))) == '(') = case head (snd(splitAt (splitAux 0 0 0 (tail  (head(formula a)))) (tail (head (formula a))))) of
                                                                                                                                '|' -> Node (formula a ++
  ...
  | otherwise = case head (snd(splitAt (splitAux 0 0 0 (head(formula a))) (head (formula a)))) of
                                                                                                                                             '&' -> Node ((formula a) ++
